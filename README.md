# NODE-DOCUMENT-STORAGE-MEMCACHED [![Build Status](https://secure.travis-ci.org/grimen/node-document-storage-memcached.png)](http://travis-ci.org/grimen/node-document-storage-memcached)

**Storage** adapter [memcached](http://memcached.org) for [node-document](https://github.com/grimen/node-document) ODM for Node.js.
...
[![Bitdeli Badge](https://d2weczhvl823v0.cloudfront.net/grimen/node-document-storage-memcached/trend.png)](https://bitdeli.com/free "Bitdeli Badge")
